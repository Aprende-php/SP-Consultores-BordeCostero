...
class BeneficioSocialController extends Controller
{
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('BeneficioSocial');
	...
	*/
	...
	{
		$model=new BeneficioSocial('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['BeneficioSocial']))
			$model->attributes=$_GET['BeneficioSocial'];
	...
	* @return BeneficioSocial the loaded model
	* @throws CHttpException
	*/
	public function loadModel($id)
	{
		$model=BeneficioSocial::model()->findByPk($id);
		if($model===null)
	...
	* @param BeneficioSocial $model the model to be validated
	*/
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='beneficio-social-form')
		{
