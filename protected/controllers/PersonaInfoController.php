...
class PersonaInfoController extends Controller
{
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('PersonaInfo');
	...
	*/
	...
	{
		$model=new PersonaInfo('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PersonaInfo']))
			$model->attributes=$_GET['PersonaInfo'];
	...
	*/
	...
	{
		$model=PersonaInfo::model()->findByPk($id);
		if($model===null)
	...
	* @param PersonaInfo $model the model to be validated
	*/
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='persona-info-form')
		{
